...
variable "main_api_server_domain" {
  ...
  type        = string
  default     = "nagrasmokeserver.cloud"
}

variable "dev_api_server_domain" {
  description = "Main API Server Domain"
  type        = string
  default     = "api.dev.nagrasmokeserver.cloud"
}

variable "ec2_iam_role_name" {
  description = "EC2 IAM Role name"
  type        = string
  default     = "smokeServer-ec2-role"
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Policy name"
  type        = string
  default     = "smokeServer-ec2-role-policy"
}

variable "ec2_instance_profile_name" {
  description = "EC2 Instance Profile Name"
  type        = string
  default     = "smokeServer-ec2-instance-profile"
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "smokeServer-codedeploy-role"
}
