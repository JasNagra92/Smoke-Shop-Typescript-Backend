...
const user_model_1 = require("src/features/user/models/user.model");
class AuthServices {
    ...
    findUserByResetToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield user_model_1.userModel.findOne({ passwordResetToken: token, passwordResetExpires: { $gt: Date.now() } }).exec();
            return user;
        });
    }
}
